                ...
                <div>
                    <div class="collist">
                        <div class="tableHeader addheader">
                            ...
                            <div class="columstatusads">{{ $t(headers.Sound) }}</div>
                            <div class="columstatusads">{{ $t(headers.Rating) }}</div>
                            <div class="columstatusads">{{ $t(headers.Date) }}</div>
                        ...
                        <div v-for="(val, i) in List" :key="i">
                            <div class="tableBody addbody">
                                ...
                                <!-- เสียงภาพ -->
                                <div class="columstatusads">
                                    {{ val.sound_main == 0 ? "Sountrack" : "Thai" }}
                                </div>
                                <!-- คะแนน -->
                                <div class="columstatusads">
                                    {{ val.ratescore }}
